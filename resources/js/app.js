...
Alpine.data('questionnaireApp', () => ({
    ...
    form: {
        ...
        nmpq: Array(window.QUESTIONNAIRE_DATA.nmpqCount).fill(null),
        dass_depression: Array(window.QUESTIONNAIRE_DATA.dassDepressionCount).fill(null),
        dass_anxiety: Array(window.QUESTIONNAIRE_DATA.dassAnxietyCount).fill(null),
    },
    ...
    async submit() {
        ...
        try {
            ...
            this.results = {
                nmpq: findCategory(window.QUESTIONNAIRE_DATA.nmpqCategories, data.nomophobia_category),
                dass_depression: findCategory(window.QUESTIONNAIRE_DATA.dassDepressionCategories, data.dass_depression_category),
                dass_anxiety: findCategory(window.QUESTIONNAIRE_DATA.dassAnxietyCategories, data.dass_anxiety_category),
            };
